# HP-LEASE — Decision Log
*(Kit exemplar — append-only, one dated row per decision, newest last, every row cites its source.
The log answers "why is it this way?" months later without re-reading the meeting record.)*

**Tier 3 — dated decision log (append-only).**

| Date | Decision | Source |
|---|---|---|
| [260528] | **Pursue lease-up over outright sale** — lease economics beat the [260520] sale indication; HP-SALE exploration closed (memo written) | `00_HQ/Meetings/260528_Mtg_Partners_HP-LEASE_PathDecision.md` |
